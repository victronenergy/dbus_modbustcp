# Shared build configuration for the dbus-modbustcp and dbus-modbusrtu binaries.
# Each binary has its own .pro that sets TARGET, adds its transport-specific
# sources/headers and then includes this file.
