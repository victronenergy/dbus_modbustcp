...
try:
  result = client.read_holding_registers(3,34, unit=254)
...
try:
  result = client.write_register(33, 2, unit=254)
except ModbusException:
  print "\tFail"
else:
  print "\tPass"
...
try:
  result = client.read_holding_registers(33,1, unit=254)
except ModbusException:
  print "\tFail"
else:
  print "\tPass", result.registers
...
try:
  result = client.write_register(33, mode, unit=254)
except ModbusException:
  print "\tFail"
else:
  print "\tPass"
...
try:
  result = client.read_input_registers(259,2,unit=239)
except Exception:
...
try:
  result = client.write_registers(33,[2]*1,unit=254)
except ModbusException:
  print "\tFail"
else:
  print "\tPass"
...
try:
  result = client.write_registers(33,[mode]*1,unit=254)
except ModbusException:
  print "\tFail"
else:
  print "\tPass"
...
try:
  result = client.write_registers(22,[100]*1,unit=254)
except ModbusException:
  print "\tFail"
else:
  print "\tPass"
...
try:
  result = client.write_register(31, 2, unit=254)
except:
#ModbusException:
  print "\tPass"
  pass
